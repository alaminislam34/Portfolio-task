    ...
    <div className="w-11/12 mx-auto pt-12 pb-6">
      <div className="flex flex-col justify-between">
        <div className="relative">
          <h1 className="absolute top-1/2 -translate-y-1/2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4 my-6">
          <div className="text-white flex flex-col justify-between bg-black rounded-3xl p-6 min-h-[220px] group hover:rotate-4 duration-300 hover:bg-[#C5FF41]">
